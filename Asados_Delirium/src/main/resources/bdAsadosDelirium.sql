...
drop schema if exists asadosdelirium;
drop user if exists adminAsados;
CREATE SCHEMA asadosdelirium ;

/*Se crea un usuario para la base de datos llamado "adminAsados" y tiene la contraseña "admin123"*/
create user 'adminAsados'@'%' identified by 'admin123';


/*Se asignan los prvilegios sobr ela base de datos TechShop al usuario creado */
grant all privileges on asadosdelirium.* to 'adminAsados'@'%';
flush privileges;

use asadosdelirium;

/* la tabla de menu contiene categorias de los tipos de platillos*/
create table menu (
...
create table producto (
  ...
  foreign key fk_producto_caregoria (id_categoria) references menu(id_categoria)  
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
INSERT INTO menu (id_categoria,descripcion,ruta_imagen,activo) VALUES 
('1','Carnes al vacío', 'https://media.scoolinary.app/blog/images/2020/06/cocinaalvacio-scoolary2-1-scaled-e1594294954798.jpg',   true), 
('2','Platillos',  'https://150855064.v2.pressablecdn.com/wp-content/uploads/2021/01/Receta-abril2.jpg',   true),
('3','Pinchos','https://www.bekiacocina.com/images/cocina/0000/647-h.jpg',true),
('4','Vegetarianos','https://mfacdn.cachefly.net/chooseveg/sites/3/2019/02/alimentos-veganos-parrilla.jpg',    false);
